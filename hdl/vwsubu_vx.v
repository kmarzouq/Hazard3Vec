    ...
    case(sew)
        8: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                Ovflw8[j] = (temp8[j] < Aext8) || (temp8[j] < B8[j]);
        ...
        16: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                Ovflw16[j] = (temp16[j] < Aext16) || (temp16[j] < B16[j]);
        ...
        32: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                Ovflw32[j] = (temp32[j] < Aext32) || (temp32[j] < B32[j]);
        ...
        64: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                Ovflw64[j] = (temp64[j] < Aext64) || (temp64[j] < B64[j]);

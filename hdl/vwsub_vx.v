    ...
    case(sew)
        8: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                temp8[j] = B8[j] - Aext8; //widening addition (16-bit result)
                Ovflw8[j] = (Aext8 > 0 && B8[j] > 0 && temp8[j] < 0) || (Aext8 < 0 && B8[j] < 0 && temp8[j] >= 0);
                ...
                if (j < vl) begin
                    ...
                    if (mask_out[j]) begin
                        if (Ovflw8[j]) S8[j] = (temp8[j] < 0) ? 16'h8000 : 16'h7FFF;
        ...
        16: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                temp16[j] = B16[j] - Aext16; //widening addition (16-bit result)
                Ovflw16[j] = (Aext16 > 0 && B16[j] > 0 && temp16[j] < 0) || (Aext16 < 0 && B16[j] < 0 && temp16[j] >= 0);
                ...
                if (j < vl) begin
                    ...
                    if (mask_out[j]) begin
                        if (Ovflw16[j]) S16[j] = (temp16[j] < 0) ? 32'h80000000 : 32'h7FFFFFFF;
        ...
        32: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                temp32[j] = B32[j] - Aext32; //change to sew = 64
                Ovflw32[j] = (Aext32 > 0 && B32[j] > 0 && temp32[j] < 0) || (Aext32 < 0 && B32[j] < 0 && temp32[j] >= 0);
                ...
                if (j < vl) begin
                    ...
                    if (mask_out[j]) begin
                        if (Ovflw32[j]) S32[j] = (temp32[j] < 0) ? 64'h8000000000000000 : 64'h7FFFFFFFFFFFFFFF;
        ...
        64: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                temp64[j] = B64[j] - Aext64; //change to sew = 128
                Ovflw64[j] = (Aext64 > 0 && B64[j] > 0 && temp64[j] < 0) || (Aext64 < 0 && B64[j] < 0 && temp64[j] >= 0);
                ...
                if (j < vl) begin
                    ...
                    if (mask_out[j]) begin
                        if (Ovflw64[j]) S64[j] = (temp64[j] < 0) ? 128'h80000000000000000000000000000000 : 128'h7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF;

// Compute widening unsigned vector-vector subtraction between two vectors of length XLEN bits and various SEW bits (single element width), resulting in a 2*SEW bit output
...
// funct6: 110010 (vwaddu) for Vector Instruction Listing

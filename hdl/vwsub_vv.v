    ...
    case(sew)
        8: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                Ovflw8[j] = (A8[j] > 0 && B8[j] > 0 && temp8[j] < 0) || (A8[j] < 0 && B8[j] < 0 && temp8[j] >= 0);
        ...
        16: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                Ovflw16[j] = (A16[j] > 0 && B16[j] > 0 && temp16[j] < 0) || (A16[j] < 0 && B16[j] < 0 && temp16[j] >= 0);
        ...
        32: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                Ovflw32[j] = (A32[j] > 0 && B32[j] > 0 && temp32[j] < 0) || (A32[j] < 0 && B32[j] < 0 && temp32[j] >= 0);
        ...
        64: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                Ovflw64[j] = (A64[j] > 0 && B64[j] > 0 && temp64[j] < 0) || (A64[j] < 0 && B64[j] < 0 && temp64[j] >= 0);

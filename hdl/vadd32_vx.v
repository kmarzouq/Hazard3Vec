    ...
    case(sew)
        8: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                temp8[j] = B8[j] + Aext8;
                //Ovflw8[j] = (Aext8 && B8[j][7] && ~temp8[j][7]) || (~Aext8 && ~B8[j][7] && temp8[j][7]);
                Ovflw8[j]  = (Aext8[7] == B8[j][7]) && (temp8[j][7] != Aext8[7]);
        ...
        16: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                //Ovflw16[j] = (Aext16 && B16[j][15] && ~temp16[j][15]) || (~Aext16 && ~B16[j][15] && temp16[j][15]);
                Ovflw16[j] = (Aext16[15] == B16[j][15]) && (temp16[j][15] != Aext16[15]);
        ...
        32: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                //Ovflw32[j] = (Aext32 && B32[j][31] && ~temp32[j][31]) || (~Aext32 && ~B32[j][31] && temp32[j][31]);
                Ovflw32[j] = (Aext32[31] == B32[j][31]) && (temp32[j][31] != Aext32[31]);
        ...
        64: begin
            for (j = 0; j < vecwidth; j = j + 1) begin
                ...
                //Ovflw64[j] = (Aext64 && B64[j][63] && ~temp64[j][63]) || (~Aext64 && ~B64[j][63] && temp64[j][63]);
                Ovflw64[j] = (Aext64[63] == B64[j][63]) && (temp64[j][63] != Aext64[63]);

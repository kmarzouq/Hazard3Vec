...
parameter IND_UNORDER    = 2'h01, //use vector elements as offsets for load/store | DO NOT CARE ABOUT ORDER OF DATA LOADED
parameter STRIDED        = 2'h10, //use stride provided by scalar register as offset between each calc
parameter IND_ORDER      = 2'h11, //use vector elements as offsets for load/store | CARE ABOUT ORDER OF DATA LOADED

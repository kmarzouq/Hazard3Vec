...
`define RVPOC_VEC_LOAD    32'b?????????????????????????0000111 //load vector 
`define RVPOC_VEC_STORE   32'b?????????????????????????0100111 //store vector
`define RVPOC_VEC_ARITH   32'b?????????????????????????1010111 //arithmetic vector op
`define RVPOC_VEC_VSETVLI 32'b0????????????????111?????1010111 //vsetvli vector op
`define RVPOC_VEC_VSETIVLI 32'b11???????????????111?????1010111 //vsetvli vector op
`define RVPOC_VEC_VSETVL  32'b1000000??????????111?????1010111 //vsetvl vector op

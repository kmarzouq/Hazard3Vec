...
#endif
            VL_FATAL_MT("vmul_vv_uptb.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtestbench___024root___ctor_var_reset(Vtestbench___024root* vlSelf) {
    ...
    // Body
    vlSelf->testbench__DOT__vtype = VL_RAND_RESET_I(32);
    vlSelf->testbench__DOT__vxrm = VL_RAND_RESET_I(2);
    vlSelf->testbench__DOT__vl = VL_RAND_RESET_I(32);
    vlSelf->testbench__DOT__vlenb = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(1024, vlSelf->testbench__DOT__A);
    VL_RAND_RESET_W(1024, vlSelf->testbench__DOT__B);
    vlSelf->testbench__DOT__vmask = VL_RAND_RESET_I(32);
    vlSelf->testbench__DOT__Ovflw = VL_RAND_RESET_I(32);
    vlSelf->testbench__DOT__vxsat_comb = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(1024, vlSelf->testbench__DOT__dut__DOT__P_comb);
    }
